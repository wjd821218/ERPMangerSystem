...
namespace ErpManageLibrary
{
    ...
    public class ClientManage
    {
        ...
        public DataTable GetClientData()
        {
            ...
            try
            {
                string ps_Sql = "select Guid,SimpName as  客户简称,[Name] as 客户名称,LinkMan as 联系人,Telephone as 电话,Fax as 传真,Address as 地址,Zip as 邮编,SellType as 销售类别,ProductName as 产品名称,Remark as  备注,Case when IsEnable=1 then '停用' when IsEnable=0 then '可用' end as 是否可用  from Client ";
        ...
        public DataTable GetClientData(string ClientGuid)
        {
            ...
            try
            {
                string ps_Sql = "select Guid,SimpName as  客户简称,[Name] as 客户名称,LinkMan as 联系人,Telephone as 电话,Fax as 传真,Address as 地址,Zip as 邮编,SellType as 销售类别,ProductName as 产品名称,Remark as  备注,Case when IsEnable=1 then '停用' when IsEnable=0 then '可用' end as 是否可用 from Client where Guid='" + ClientGuid + "'";
                DataTable pDTMain = pObj_Comm.ExeForDtl(ps_Sql);
