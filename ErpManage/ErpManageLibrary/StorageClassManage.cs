    ...
    public class StorageClassManage
    {
        ...
        public void UpdateTypeNode(string InterID, string InterName)
        {
            ...
            try
            {
                ...
                string StrSQL = "";
                StrSQL = "Update  StorageClass  set  InterName='" + InterName + "'  where InterID='" + InterID + "'";
        ...
        /// </summary>
        /// <returns>pDTMain 字段信息集</returns>
        public DataTable GetStorageClassDatabyBom()
        {
            string ps_Sql = "";
            DataTable pDTMain = new DataTable();
            CommonInterface pObj_Comm = CommonFactory.CreateInstance(CommonData.sql);
            try
            {
                ps_Sql = "select * from StorageClass where InterID='6' or FatherID='6' or InterID='0000'";
                pDTMain = pObj_Comm.ExeForDtl(ps_Sql);
