...
namespace ErpManage.PrintReport
{
    ...
    /// 半成品入库单
    /// </summary>
    public partial class XtraReportHalfGoods: DevExpress.XtraReports.UI.XtraReport
    {
        public DataSet ds;
        public XtraReportHalfGoods(DataSet ds1, string HalfGoodsID, string HalfGoodsDate, string Plant,
            ...
            ,string CreateName, string CreateDate, string CheckName, string CheckDate)
        {
            ...
            DataBind( ds1,   HalfGoodsID,  HalfGoodsDate,  Plant,
        ...
        /// 绑定数据
        /// </summary>
        private void DataBind(DataSet ds1, string HalfGoodsID, string HalfGoodsDate, string Plant,
            string IncomeDepot, string TransactorPerson, string SatrapPerson, string QualityPerson, string DepotPerson, string BatchNo,string Remark
            , string CreateName, string CreateDate, string CheckName, string CheckDate)
        {
            this.DataSource = ds1;
            ...
            xrHalfGoodsID.Text = HalfGoodsID;
            xrHalfGoodsDate.Text = DateTime.Parse(HalfGoodsDate).ToString("yyyy-MM-dd");
            xrPlant.Text = Plant;
            ...
            xrMaterialID.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.MaterialID");
            xrMaterialName.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.MaterialName");
            xrSpec.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.Spec");
            xrUnit.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.Unit");
            xrMaterialSum.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.MaterialSum");
            xrDeterminant.DataBindings.Add("Text", DataSource, "HalfGoodsDetail.Determinant");

            xrMaterialSum.DataBindings.AddRange(new XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", DataSource, "HalfGoodsDetail.MaterialSum", "{0:0.###}") });
