...
namespace ErpManage.PrintReport
{
    ...
    /// 其它入库单
    /// </summary>
    public partial class XtraReportOtherInOrder : DevExpress.XtraReports.UI.XtraReport
    {
        public DataSet ds;
        public XtraReportOtherInOrder(DataSet ds1, string InOrderID, string InOrderDate, string InStorage,
            string StoragePerson, string QualityPerson, string BatchNo,string Remark
            , string CreateName, string CreateDate, string CheckName, string CheckDate,bool IsDisplayPrice)
        {
            ...
            DataBind(ds1, InOrderID, InOrderDate, InStorage,
             StoragePerson, QualityPerson,BatchNo , Remark, CreateName, CreateDate, CheckName, CheckDate, IsDisplayPrice);
        }

        /// <summary>
        /// 绑定数据
        /// </summary>
        private void DataBind(DataSet ds1, string InOrderID, string InOrderDate, string InStorage,
            string StoragePerson, string QualityPerson,string BatchNo,string Remark
            , string CreateName, string CreateDate, string CheckName, string CheckDate, bool IsDisplayPrice)
        {
            this.DataSource = ds1;
            ...
            xrOtherInOrderID.Text = InOrderID;
            xrOtherInOrderDate.Text = DateTime.Parse(InOrderDate).ToString("yyyy-MM-dd");
