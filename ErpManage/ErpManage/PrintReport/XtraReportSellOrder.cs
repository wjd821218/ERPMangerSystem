...
namespace ErpManage.PrintReport
{
    ...
    /// 销售出库单
    /// </summary>
    public partial class XtraReportSellOrder : DevExpress.XtraReports.UI.XtraReport
    {
        public DataSet ds;
        public XtraReportSellOrder(DataSet ds1, string Client, string SellOrderID, string SellOrderDate, string OutStorage,
            string StoragePerson, string QualityPerson, string Remark
            , string CreateName, string CreateDate, string CheckName, string CheckDate, string CheckName2, string CheckDate2,bool IsDisplayPrice)
        {
            InitializeComponent();
            ...
            DataBind(ds1, Client, SellOrderID, SellOrderDate, OutStorage,
             StoragePerson, QualityPerson, Remark, CreateName, CreateDate, CheckName, CheckDate, CheckName2, CheckDate2, IsDisplayPrice);
        }
            ...
            , string CreateName, string CreateDate, string CheckName, string CheckDate, string CheckName2, string CheckDate2, bool IsDisplayPrice)
        {
            ...
            xrSellOrderID.Text = SellOrderID;
            xrSellOrderDate.Text = DateTime.Parse(SellOrderDate).ToString("yyyy-MM-dd");
            ...
            xrClientOrderID.DataBindings.Add("Text", DataSource, "SellOrderDetail.ClientOrderID");
            ...
            xrBoxSum.DataBindings.Add("Text", DataSource, "SellOrderDetail.BoxSum");
            ...
            xrBoxSum.DataBindings.AddRange(new XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", DataSource, "SellOrderDetail.BoxSum", "{0:0.###}") });
