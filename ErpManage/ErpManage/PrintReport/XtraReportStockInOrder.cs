...
namespace ErpManage.PrintReport
{
    ...
    /// 采购入库单
    /// </summary>
    public partial class XtraReportStockInOrder: DevExpress.XtraReports.UI.XtraReport
    {
        public DataSet ds;
        public XtraReportStockInOrder(DataSet ds1, string Supplier, string StockInOrderID, string StockInOrderDate, string InStorage,
            string StockPerson, string StoragePerson,string  BatchNo,string Remark, string CreateName, string CreateDate, string CheckName, string CheckDate)
        {
            InitializeComponent();
            ...
            DataBind( ds1,  Supplier,  StockInOrderID,  StockInOrderDate,  InStorage,
             StockPerson, StoragePerson, BatchNo, Remark, CreateName, CreateDate, CheckName, CheckDate);
        }
            ...
            string StockPerson, string StoragePerson, string BatchNo, string Remark, string CreateName, string CreateDate, string CheckName, string CheckDate)
        {
            ...
            xrMaterialSum.DataBindings.AddRange(new XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", DataSource, "StockInOrderDetail.MaterialSum", "{0:0.###}") });

            xrDeliverySum.DataBindings.AddRange(new XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", DataSource, "StockInOrderDetail.DeliverySum", "{0:0.###}") });

            xrStorageSum.DataBindings.AddRange(new XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", DataSource, "StockInOrderDetail.StorageSum", "{0:0.###}") });
